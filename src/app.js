...
app.post('/wp/get_ChatListTransm', wp.getAllChatListTransm);
...
app.post('/wp/sendListButtons', wp.sendListButtons);
app.post('/wp/sendButtons', wp.sendButtons);
...
app.post('/wp/check_number',wp.checkNumberStatus);
